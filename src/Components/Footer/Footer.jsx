        ...
        <Box
            ...
            <Container
                ...
                <Stack direction={'row'} spacing={6}>
                    <SocialButton label={'Github'} href={'https://github.com/Tanyagrover22'}>
                        <FaGithub />
                    </SocialButton>
                    <SocialButton label={'Linkedin'} href={'https://www.linkedin.com/in/tanya-grover-09468325b/'}>
                        <FaSnapchat />
                    </SocialButton>
                    <SocialButton label={'Instagram'} href={'https://www.instagram.com/garima_xxo/'}>
                        <FaInstagram />
                    </SocialButton>
                </Stack>
            </Container>
